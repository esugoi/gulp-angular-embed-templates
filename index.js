...
var Angular2StyleProcessor = require('./lib/Angular2StyleProcessor');
...
module.exports = function (options) {
    ...
    switch (sourceType) {
        case 'ts':
            options.processors = [new Angular1Processor(), new Angular2TypeScriptTemplateProcessor(), new Angular2StyleProcessor()];
            break;
        case 'js':
        default:
